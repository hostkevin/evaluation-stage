	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url(); ?>assets/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="<?php echo site_url(); ?>/AdminController/Admin/checkadmin" class="login100-form validate-form" method="post">
                    ...
                    <p class="text-danger"><?=$this->session->flashdata('errorAdmin') ?>   
